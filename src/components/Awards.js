        ...
        <div className="projects-grid">
          <Cell col={4}>
            ...
            <Card
              className="cards"
              shadow={5}
              style={{ minWidth: "1000", margin: "20", width: "700" }}
            >
          ...
          <Cell col={4}>
            {/* Project 2 */}
            <Card shadow={5} style={{ minWidth: "450", margin: "20" }}>
              <CardTitle>
              ...
              <CardText>
                ...
                Dept. of Education, and collected related attributes from
                various governmental websites such as FBI, Dept. of Labor, US
                Census Bureau etc. Then I ran various Machine Learning
                algorithms using the platform ‘Weka’ on the training dataset of
                approximately 1.5M data points to find out the best predictive
                model.
              </CardText>
              <CardActions border>
          ...
          <Cell col={4}>
            ...
            <Card shadow={5} style={{ minWidth: "450", margin: "20" }}>
              ...
              <CardText>
                ...
                applications on MIT App-Inventor 2 for Android utilizing Google
                drive and Fusion table APIs.
              </CardText>
              <CardActions border>
          ...
          <Cell col={8}>
            {/* Project 1 */}
            <Card shadow={5} style={{ minWidth: "600", margin: "20" }}>
              <CardTitle
                style={{
                  color: "#fff",
                  height: "350px",
              ...
              <CardText>
                I was an Intel ISEF finalist for my project that predicted
                safety rates for different colleges using machine learning.
              </CardText>
              <CardActions border />
